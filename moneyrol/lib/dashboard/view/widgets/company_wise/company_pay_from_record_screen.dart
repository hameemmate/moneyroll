...
class PayFromRecordDialog extends StatefulWidget {
  final String recordId;
  final double availableBalance;
  final String recordLabel; // e.g. "Partner A → Partner B"

  const PayFromRecordDialog({
    super.key,
  ...
  @override
  State<PayFromRecordDialog> createState() => _PayFromRecordDialogState();
}

class _PayFromRecordDialogState extends State<PayFromRecordDialog> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Available balance banner (informational only)
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Record balance: ${ctrl.currencySymbol}${widget.availableBalance.toStringAsFixed(2)} (you can pay any amount)',
                        style: TextStyle(
                          fontSize: 12,
                          color: AppConstants.textSecondary,
                        ),
              ...
              Form(
                ...
                child: Column(
                  ...
                  children: [
                    // Pay to company
                    _buildLabel('Pay To Partner', required: true),
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: (v) {
                          ...
                          // NO BALANCE LIMIT - removed the validation
                          return null;
                        },
                      ),
                    ),
